...
function Wifi(host, pin, port, model) {
  ...
  this.event_obj = (typeof obj === "undefined") ? null : event_obj;
  this.event_to_emit = (typeof obj === "undefined") ? null : event_to_emit;
...
Wifi.prototype.command = function(operation, data, callback) {
  ...
  var client = net.connect({host: this.host, port: this.port}, function() { //'connect' listener
    console.log("Writing buffer to thermostat...")
    client.write(buf);
  });
  ...
  client.on('timeout', function(e){
    this.event_to_emit = 'error';
    this.event_obj = (typeof e === 'undefined') ? new Error("Timed out") : e;
    client.end();
  }.bind(this));
